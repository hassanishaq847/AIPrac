//package com.be.aiprac.image_generation.plugins
//
...
//import com.be.aiprac.image_generation.ImageGenerationHelper
...
//            it.copy(
//                plugins = when (plugin) {
//                    0 -> ImageGenerator.ConditionOptions.ConditionType.FACE
//                    1 -> ImageGenerator.ConditionOptions.ConditionType.DEPTH
//                    2 -> ImageGenerator.ConditionOptions.ConditionType.EDGE
...
//                when(conditionType) {
//                    ImageGenerator.ConditionOptions.ConditionType.FACE -> helper?.initializeImageGeneratorWithFacePlugin(MODEL_PATH)
//                    ImageGenerator.ConditionOptions.ConditionType.EDGE -> helper?.initializeImageGeneratorWithEdgePlugin(MODEL_PATH)
//                    ImageGenerator.ConditionOptions.ConditionType.DEPTH -> helper?.initializeImageGeneratorWithDepthPlugin(MODEL_PATH)
//                }
//
...
//    val plugins: ImageGenerator.ConditionOptions.ConditionType = ImageGenerator.ConditionOptions.ConditionType.FACE,

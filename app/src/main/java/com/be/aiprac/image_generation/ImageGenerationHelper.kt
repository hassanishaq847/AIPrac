...
//            .build()
//
//        val faceConditionOptions = ImageGenerator.ConditionOptions.FaceConditionOptions.builder()
...
//            .build()
//
//        val conditionOptions = ImageGenerator.ConditionOptions.builder()
...
//            .build()
//
//        val edgeConditionOptions = ImageGenerator.ConditionOptions.EdgeConditionOptions.builder()
...
//            ImageGenerator.ConditionOptions.DepthConditionOptions.builder()
...
//        conditionType: ImageGenerator.ConditionOptions.ConditionType,
//        iteration: Int,
//        seed: Int
//    ) {
